...
This project demonstrates a **complete MLOps pipeline** for customer churn prediction, showcasing enterprise-grade practices from data processing to production deployment.
